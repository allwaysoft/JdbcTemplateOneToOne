...
public class OrderRepository {
    ...
    public final static RowMapper<LineItem> lineItemMapper = BeanPropertyRowMapper.newInstance(LineItem.class);
        ...
        return jdbcTemplate.query("select * from orders, line_item "
            ...
            public Order extractData(ResultSet rs) throws SQLException, DataAccessException {
                ...
                while (rs.next()) {
                    ...
                    order.setItem(lineItemMapper.mapRow(rs, row));
                    row++;
                }
                return order;
            }
        ...
        return jdbcTemplate.query("select * from orders, line_item "
            ...
            public List<Order> extractData(ResultSet rs) throws SQLException, DataAccessException {
                ...
                while (rs.next()) {
                    ...
                    currentOrder.setItem(lineItemMapper.mapRow(rs, itemIdx++));
                }
                return orders;
            }
